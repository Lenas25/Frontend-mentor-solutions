        ...
        <div className="text-center my-12">
          ...
          <div className="flex gap-5 flex-wrap items-center justify-center">
            <ButtonModal
              ...
              info="Nosotros tenemos la capacidad de reconocer y evaluar nuestros propios pensamientos, emociones, creencias y acciones, debido que tenemos una comprensión profunda con nosotros mismos, esto incluye muestras fortalezas, debilidades, valores, y motivaciones. Es por ello que nosotros determinamos que esta power skill es fundamental para nuestro crecimiento personal "
            />
            <ButtonModal
              image={pensando}
              text="Adaptacion al cambio"
